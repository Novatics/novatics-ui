...
- `npx storybook@latest automigrate --config-dir packages/checkbox/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir packages/checkbox-field/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/chip/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/core/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/currency-text-field/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/divider/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/masked-text-field/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/radio/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/styles/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/tokens/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir packages/wizard/.storybook --renderer undefined`
