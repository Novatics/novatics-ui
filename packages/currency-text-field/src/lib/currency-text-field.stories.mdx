...
First install the latest version of the package from `@novatics-ui-fork/currency-text-field`.
...
[ISO Currency](https://github.com/Novatics/novatics-ui/blob/dojo/NUI-15-masked-inputs/packages/currency-text-field/src/currency/currency_iso.ts)

[NON_ISO Currency](https://github.com/Novatics/novatics-ui/blob/dojo/NUI-15-masked-inputs/packages/currency-text-field/src/currency/currency_non_iso.ts)
