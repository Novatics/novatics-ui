...
Either a string to use a HTML element or a component.`,name:"component",required:!1,type:{name:'"div"'}}}}}catch{}const Ne="@novatics-ui/alert",Pe="0.1.5",we="./index.js",Re="./index.d.ts",Oe={".":{import:"./index.mjs",require:"./index.js"}},De={name:Ne,version:Pe,main:we,types:Re,exports:Oe};function Ue(n={}){const{wrapper:s}=Object.assign({},N(),n.components);return s?e.jsx(s,{...n,children:e.jsx(c,{})}):c();function c(){const r=Object.assign({h1:"h1",h3:"h3",p:"p",code:"code",pre:"pre"},N(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(me,{title:"Components/Alert",component:l}),`
`,e.jsxs(r.h1,{id:"alert-",children:["Alert ",e.jsx("img",{src:`https://img.shields.io/badge/Version-v${De.version}-brightgreenn`})]}),`
...
}`}};const y={title:"Components/Alert",component:l,tags:["stories-mdx"],includeStories:["basicUsage","severity","title"]};y.parameters=y.parameters||{};y.parameters.docs={...y.parameters.docs||{},page:Ue};const _n=["basicUsage","severity","title"];export{_n as __namedExportsOrder,H as basicUsage,y as default,q as severity,V as title};
//# sourceMappingURL=alert.stories-1508cdb3.js.map
