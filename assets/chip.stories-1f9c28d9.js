...
}`}};const s={title:"Chip",component:l,tags:["stories-mdx"],includeStories:["basicUsage","clickInteraction","deleteInteraction","size","icon","colors"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:N};const ie=["basicUsage","clickInteraction","deleteInteraction","size","icon","colors"];export{ie as __namedExportsOrder,h as basicUsage,u as clickInteraction,g as colors,s as default,m as deleteInteraction,j as icon,b as size};
//# sourceMappingURL=chip.stories-1f9c28d9.js.map
