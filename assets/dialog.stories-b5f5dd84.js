...
zIndex: -1,
})`},description:"A backdrop component. This prop enables custom backdrop rendering.\n@deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.\nUse the `slots.backdrop` prop to make your application ready for the next version of Material UI.",name:"BackdropComponent",required:!1,type:{name:"ElementType<BackdropProps>"}},BackdropProps:{defaultValue:null,description:"Props applied to the [`Backdrop`](/material-ui/api/backdrop/) element.\n@deprecated Use `slotProps.backdrop` instead.",name:"BackdropProps",required:!1,type:{name:"Partial<BackdropProps>"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},actionButtons:{defaultValue:null,description:"",name:"actionButtons",required:!1,type:{name:"ButtonProps[]"}},dialogActions:{defaultValue:null,description:"",name:"dialogActions",required:!1,type:{name:"React.ReactNode"}},headerDivider:{defaultValue:null,description:"",name:"headerDivider",required:!1,type:{name:"boolean"}},footerDivider:{defaultValue:null,description:"",name:"footerDivider",required:!1,type:{name:"boolean"}}}}}catch{}try{dialog.displayName="dialog",dialog.__docgenInfo={description:"",displayName:"dialog",props:{className:{defaultValue:null,description:"@ignore",name:"className",required:!1,type:{name:"string"}},slotProps:{defaultValue:{value:"{}"},description:"The props used for each slot inside the Modal.",name:"slotProps",required:!1,type:{name:'{ root?: SlotComponentProps<"div", ModalComponentsPropsOverrides, ModalOwnerState>; backdrop?: SlotComponentProps<OverridableComponent<BackdropTypeMap<{}, "div">>, ModalComponentsPropsOverrides, ModalOwnerState>; }'}},ref:{defaultValue:null,description:"",name:"ref",required:!1,type:{name:"Ref<HTMLDivElement>"}},components:{defaultValue:{value:"{}"},description:"The components used for each slot inside.\n\nThis prop is an alias for the `slots` prop.\nIt's recommended to use the `slots` prop instead.",name:"components",required:!1,type:{name:"{ Root?: ElementType<any>; Backdrop?: ElementType<any>; }"}},componentsProps:{defaultValue:{value:"{}"},description:"The extra props for the slot components.\nYou can override the existing props or add new ones.\n\nThis prop is an alias for the `slotProps` prop.\nIt's recommended to use the `slotProps` prop instead, as `componentsProps` will be deprecated in the future.",name:"componentsProps",required:!1,type:{name:'{ root?: SlotComponentProps<"div", ModalComponentsPropsOverrides, ModalOwnerState>; backdrop?: SlotComponentProps<OverridableComponent<BackdropTypeMap<{}, "div">>, ModalComponentsPropsOverrides, ModalOwnerState>; }'}},BackdropComponent:{defaultValue:{value:`styled(Backdrop, {
name: 'MuiModal',
slot: 'Backdrop',
overridesResolver: (props, styles) => {
return styles.backdrop;
...
zIndex: -1,
})`},description:"A backdrop component. This prop enables custom backdrop rendering.\n@deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.\nUse the `slots.backdrop` prop to make your application ready for the next version of Material UI.",name:"BackdropComponent",required:!1,type:{name:"ElementType<BackdropProps>"}},BackdropProps:{defaultValue:null,description:"Props applied to the [`Backdrop`](/material-ui/api/backdrop/) element.\n@deprecated Use `slotProps.backdrop` instead.",name:"BackdropProps",required:!1,type:{name:"Partial<BackdropProps>"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},actionButtons:{defaultValue:null,description:"",name:"actionButtons",required:!1,type:{name:"ButtonProps[]"}},dialogActions:{defaultValue:null,description:"",name:"dialogActions",required:!1,type:{name:"React.ReactNode"}},headerDivider:{defaultValue:null,description:"",name:"headerDivider",required:!1,type:{name:"boolean"}},footerDivider:{defaultValue:null,description:"",name:"footerDivider",required:!1,type:{name:"boolean"}}}}}catch{}const ze="@novatics-ui/dialog",Ke="0.1.1",Je="./index.js",Qe="./index.d.ts",Ze={".":{import:"./index.mjs",require:"./index.js"}},en={"lodash.isempty":"^4.4.0","lodash.isnil":"^4.0.0"},nn={"@mui/icons-material":"^5.14.1"},tn={name:ze,version:Ke,main:Je,types:Qe,exports:Ze,dependencies:en,peerDependencies:nn};function on(t={}){const{wrapper:n}=Object.assign({},E(),t.components);return n?e.jsx(n,{...t,children:e.jsx(i,{})}):i();function i(){const o=Object.assign({h1:"h1",h3:"h3",p:"p",code:"code",pre:"pre"},E(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(fe,{title:"Components/Dialog",component:m}),`
`,e.jsxs(o.h1,{id:"dialog-",children:["Dialog ",e.jsx("img",{src:`https://img.shields.io/badge/Version-v${tn.version}-brightgreenn`})]}),`
`,e.jsx(o.h3,{id:"installation",children:"Installation"}),`
`,e.jsxs(o.p,{children:["First install the latest version of the package from ",e.jsx(o.code,{children:"@novatics-ui/dialog"}),"."]}),`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-shell",children:`  yarn add -D @novatics-ui/dialog
`})}),`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-shell",children:`  npm install --dev @novatics-ui/dialog
`})}),`
`,e.jsx(o.p,{children:"and use it"}),`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`import ... from '@novatics-ui/dialog';
...
}`}};const b={title:"Components/Dialog",component:m,tags:["stories-mdx"],includeStories:["basicUsage","descriptionUsage","dividers"]};b.parameters=b.parameters||{};b.parameters.docs={...b.parameters.docs||{},page:on};const Yn=["basicUsage","descriptionUsage","dividers"];export{Yn as __namedExportsOrder,X as basicUsage,b as default,Y as descriptionUsage,z as dividers};
//# sourceMappingURL=dialog.stories-b5f5dd84.js.map
