...
First install the latest version of the package from `@novatics-ui/dialog`.

```shell
  yarn add -D @novatics-ui/dialog
```

```shell
  npm install --dev @novatics-ui/dialog
```

and use it

```tsx
import ... from '@novatics-ui/dialog';
