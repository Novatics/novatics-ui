...
[ISO Currency](https://github.com/Novatics/novatics-ui/blob/master/packages/currency-text-field/src/currency/currency_iso.ts)

[NON_ISO Currency](https://github.com/Novatics/novatics-ui/blob/master/packages/currency-text-field/src/currency/currency_non_iso.ts)
