...
`,e.jsxs(t.p,{children:["First install the latest version of the package from ",e.jsx(t.code,{children:"@novatics/alert"}),"."]}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-shell",children:`  yarn add -D @novatics/alert
`})}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-shell",children:`  npm install --dev @novatics/alert
`})}),`
`,e.jsx(t.p,{children:"and use it"}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-tsx",children:`import ... from '@novatics/alert';
...
//# sourceMappingURL=alert.stories-67d0269f.js.map
