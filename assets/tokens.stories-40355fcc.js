...
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-shell",children:`  yarn add -D @novatics-ui/tokens
`})}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-shell",children:`  npm install --dev @novatics-ui/tokens
`})}),`
`,e.jsx(s.p,{children:"and use it"}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-tsx",children:`import Tokens, { colors, borderRadius, shadows, spacing, typography } from '@novatics-ui/tokens';
