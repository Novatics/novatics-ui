...
zIndex: -1,
})`},description:"A backdrop component. This prop enables custom backdrop rendering.\n@deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.\nUse the `slots.backdrop` prop to make your application ready for the next version of Material UI.",name:"BackdropComponent",required:!1,type:{name:"ElementType<BackdropProps>"}},BackdropProps:{defaultValue:null,description:"Props applied to the [`Backdrop`](/material-ui/api/backdrop/) element.\n@deprecated Use `slotProps.backdrop` instead.",name:"BackdropProps",required:!1,type:{name:"Partial<BackdropProps>"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},actionButtons:{defaultValue:null,description:"",name:"actionButtons",required:!1,type:{name:"ButtonProps[]"}},dialogActions:{defaultValue:null,description:"",name:"dialogActions",required:!1,type:{name:"React.ReactNode"}},headerDivider:{defaultValue:null,description:"",name:"headerDivider",required:!1,type:{name:"boolean"}},footerDivider:{defaultValue:null,description:"",name:"footerDivider",required:!1,type:{name:"boolean"}}}}}catch{}const ze="@novatics-ui/dialog",Ke="0.2.2",Je="./index.js",Qe="./index.d.ts",Ze={".":{import:"./index.mjs",require:"./index.js"}},en={"lodash.isempty":"^4.4.0","lodash.isnil":"^4.0.0"},nn={"@mui/icons-material":"^5.14.1"},tn={name:ze,version:Ke,main:Je,types:Qe,exports:Ze,dependencies:en,peerDependencies:nn};function on(t={}){const{wrapper:n}=Object.assign({},E(),t.components);return n?e.jsx(n,{...t,children:e.jsx(i,{})}):i();function i(){const o=Object.assign({h1:"h1",h3:"h3",p:"p",code:"code",pre:"pre"},E(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(fe,{title:"Components/Dialog",component:m}),`
...
//# sourceMappingURL=dialog.stories-b390bee1.js.map
